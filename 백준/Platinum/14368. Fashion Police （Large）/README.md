# [Platinum IV] Fashion Police (Large) - 14368 

[문제 링크](https://www.acmicpc.net/problem/14368) 
...
해 구성하기, 수학, 정수론, 비둘기집 원리

### 제출 일자

2026년 1월 17일 17:17:39

### 문제 설명

<p>You are so excited about the 2016 Code Jam World Finals that you just moved to New York. You have brought along J different jackets (numbered 1 through J), P different pairs of pants (numbered 1 through P), and S different shirts (numbered 1 through S). You have at least as many shirts as pairs of pants, and at least as many pairs of pants as jackets. (J ≤ P ≤ S.)</p>
